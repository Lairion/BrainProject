"""
Django settings for DjandJS project.
...
SECRET_KEY = '2^71mov&7*^xfu(%xx((vw)@81%udnh3u^dfu)4clhz2322)%c'
...
WSGI_APPLICATION = 'DjandJS.wsgi.application'
